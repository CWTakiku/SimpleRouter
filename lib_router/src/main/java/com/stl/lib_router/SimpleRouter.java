...
public class SimpleRouter {
            ...
            try {
                ...
                if (clazz != null) {
                    if (clazz.isAnnotationPresent(SimpleRouterClassRegister.class)) {
                        String key = clazz.getAnnotation(SimpleRouterClassRegister.class).key();
    ...
    public void startActivity(String key, Bundle bundle, int flags) {
        ...
        if (curSimpleRouterObj != null && curSimpleRouterObj.type == SimpleRouterObj.ACTIVITY) {
            Intent intent = new Intent(application, curSimpleRouterObj.clazz);
            if (bundle != null) {
    ...
    public void startActivityForResult(@NonNull Activity activity, String key, int requestCode, Bundle bundle) {
        ...
        if (routerObj != null && activity != null && routerObj.type == SimpleRouterObj.ACTIVITY) {
    ...
    public Fragment getFragment(String key, Bundle bundle) {
        ...
        SimpleRouterObj curSimpleRouterObj = getSimpleRouterObj(key);
        if (curSimpleRouterObj != null && curSimpleRouterObj.type == SimpleRouterObj.FRAGMENT) {
            try {
